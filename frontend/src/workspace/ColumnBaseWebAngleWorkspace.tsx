...
export function ColumnBaseWebAngleWorkspace() {
  ...
  return <ConnectionWorkspaceShell className="clip-angle-workspace paired-clip-angle-workspace column-base-web-angle-workspace" banner={<section className="workspace-banner"><div><p className="eyebrow">Stage 3.7A · Column-base profile matrix</p><h2>Column connection — Single/double base angles to concrete</h2><p>Independent component design demands, exact generated moments, and one foundation reaction.</p></div><div className="benchmark-actions"><button type="button" className="secondary-button" onClick={() => { loadBenchmark("US_CUSTOMARY"); }}>Load 3.7A U.S.</button><button type="button" className="secondary-button" onClick={() => { loadBenchmark("SI"); }}>Load 3.7A SI</button></div></section>}>
